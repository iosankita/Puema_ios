...
open class SkyFloatingLabelTextFieldWithIcon: SkyFloatingLabelTextField {
    ...
    @IBInspectable
        open var alignIconRight: Bool = true
    
    /// A float value that determines the width of the icon
    @IBInspectable
    dynamic open var iconWidth: CGFloat = 18 {
        didSet {
            updateFrame()
        }
    }
    ...
    */
    ...
    fileprivate func createIconLabel() {
        ...
        if alignIconRight{
                 iconLabel.autoresizingMask = [.flexibleTopMargin, .flexibleLeftMargin]
             }
    ...
    fileprivate func createIconImageView() {
        ...
        if alignIconRight{
            iconImageView.autoresizingMask = [.flexibleTopMargin, .flexibleLeftMargin]
        }
    ...
    */
    ...
    override open func textRect(forBounds bounds: CGRect) -> CGRect {
        ...
        if isLTRLanguage {
            rect.origin.x = 0//-= CGFloat(iconWidth + iconMarginLeft)
        } else {

...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    fileprivate let textRectYPosition: CGFloat = 10
    ...
    @objc dynamic open var titleFont: UIFont = AppFont.semiBold.fontWithSize(13) {
        didSet {
            updateTitleLabel()
        }
    }
    ...
    */
    override open func textRect(forBounds bounds: CGRect) -> CGRect {
        ...
        let rect = CGRect(
            ...
            y: self.textRectYPosition/*titleHeight*/,
